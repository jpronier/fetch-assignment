...
/*
Now, this interpretation can lead to some issues. If a customer buys 100 items 
from a single brand A, but 100 customers buy 1 item from brand B, brand A will 
be ranked higher than brand B, which is not a good interpretation of what a top 
brand is.

So now, let's decide that we want to look at the total number of receipts per 
